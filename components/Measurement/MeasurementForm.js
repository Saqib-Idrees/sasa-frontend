        ...
        <div className="space-y-4 mt-7">
          {Object.values(component.measurement).map((measurement, index) => (
            <div key={index} className="pb-4 flex items-center">
              <label className="font-normal w-1/3">{measurement.label}</label>
              <input
                className="text-base px-4 py-3 bg-gray-100 border rounded-lg focus:outline-none focus:border-black w-2/3"
                type="text"
